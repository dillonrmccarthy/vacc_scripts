...
env SCHRODINGER_CUDA_VISIBLE_DEVICES=$gpuval $SCHRODINGER/utilities/multisim -JOBNAME $jobname -HOST $host -maxjob 1 -cpu 1 -m $msj -c $cfg -description 'Molecular Dynamics' $cms -mode umbrella -set stage[1].set_family.md.jlaunch_opt=["-gpu"] -o $jobname-out.cms -ATTACHED 
